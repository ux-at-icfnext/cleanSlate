...
title: Sample Prototype Page- Collections Component
type: [sub-nav-item, prototype]
permalink: /prototype/collections-component/
description: Sample prototype page, collections component
---
      ...
      <ul class="usa-collection__meta" aria-label="More information">
        <li class="usa-collection__meta-item position-relative">
          <svg
            ...
            role="img"
          >
            <use xlink:href="/assets/uswds/dist/img/sprite.svg#public"></use>
          </svg>
          Digital.gov
        </li>
      </ul>
